...
export default function ManagerPage() {
    ...
    useEffect(() => {
        async function fetchManagers() {
            try {
                const res = await axiosServices.get<ResponsePaginate<User>>("/api/admin/managers");
            ...
            <div className="row page-titles mx-0">
                <div className="col-sm-6 p-md-0">
                    <div className="welcome-text">
                        <h4>Gestionnaire!</h4>
                        <p className="mb-0">Liste des gestionnaires</p>
                    </div>
                </div>
                        ...
                        <div className="card-body">
                            <div className="mb-3 d-flex justify-content-between align-items-center">
                                <input
                                    ...
                                    style={{ flex: 1 }}
                                />
                                <Link className="btn btn-primary" href="/managers/add">
                                ...
                                <table className="table table-sm mb-0 table-striped student-tbl">
                                    ...
                                    {filteredManagers.map((customer) => (
                                        <tr key={customer.id} className="btn-reveal-trigger">
                                            ...
                                            <td className="py-2 ps-5">{customer.forage}</td>
                                            ...
                                            <td className="py-2 text-end">
                                                <Dropdown className="text-end">
                                                    ...
                                                    <Dropdown.Menu>
                                                        <Dropdown.Item>
                                                            <Link href={`/managers/${customer.id}/edit`}>
                                                                Modifier
                                                            </Link>

                                                        </Dropdown.Item>
                                                        <Dropdown.Divider />
                                                        <Dropdown.Item onClick={cancelProduct} className="text-danger">
                                                            Annuler
                                                        </Dropdown.Item>
                                                    </Dropdown.Menu>
                                                </Dropdown>
